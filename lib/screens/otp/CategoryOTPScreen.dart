import 'package:apptagon_flutter_uis/screens/otp/OtpOneScreen.dart';
import 'package:apptagon_flutter_uis/screens/otp/VerifyOtpOneScreen.dart';
...
class CategoryOTPScreen extends StatefulWidget {
  const CategoryOTPScreen({super.key});

  @override
  State<CategoryOTPScreen> createState() => _CategoryOTPScreenState();
}

class _CategoryOTPScreenState extends State<CategoryOTPScreen> {
  List categories = [
    {
      "name": "OTP ONE",
      "page": const OtpOneScreen(),
    },
     {
      "name": "VERIFY OTP ONE",
